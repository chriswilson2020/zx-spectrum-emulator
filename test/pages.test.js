...
test("TI-85 page exposes a live calculator LCD viewer entry point", async () => {
  ...
  assert.match(ti85, /\.\/public\/free85\/Release_2\.20\/Free85-Manual-typeset\.pdf/);
  assert.match(ti85, /\.\/public\/free85\/Release_2\.20\/Free85-Guidebook-typeset\.pdf/);
  assert.match(ti85, /\.\/public\/free85\/Release_2\.20\/Free85-Companion-typeset\.pdf/);
...
test("build:pages creates a static dist tree for GitHub Pages", async () => {
  ...
  assert.equal(existsSync("dist/public/free85/Release_2.20/manifest.json"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Manual-typeset.html"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Manual-typeset.pdf"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Guidebook-typeset.html"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Guidebook-typeset.pdf"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Companion-typeset.html"), true);
  assert.equal(existsSync("dist/public/free85/Release_2.20/Free85-Companion-typeset.pdf"), true);
